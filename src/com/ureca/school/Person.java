...
/*
 * 리팩토링 했을 때 printAll()은 없었음 -> 복사해서 만든거
 * 오버라이딩을 할라면 접근 지정자의 범위가 같거나 더 넓어야됨
 * return 타입은 상관 없음
 * 파라미터와 메소드 명은 반드시 같아야 됨
 * 폴리몰티즘? 을 완벽하게 하려면 Exception도 고려해야됨
 */
	public void printAll() /*throws IOException*/{
//		System.out.print(getName() + "\t" + getAge() + "\t");
		/*
		 * toString Override 했을 경우 사용할 수 있음
		 * 아래 세개는 모두 같은 결과 출력
		 */
